...
CROSS_COMPILE=/usr/arm-frc-linux-gnueabi/bin/arm-frc2021-linux-gnueabi- ./configure --no-tests --no-samples --omit=Data/ODBC,Data/MySQL --minimal --prefix=/usr/arm-frc-linux-gnueabi/ --static --cflags="-fPIC"
sudo CROSS_COMPILE=/usr/arm-frc-linux-gnueabi/bin/arm-frc2021-linux-gnueabi- make -j4 install
cd
