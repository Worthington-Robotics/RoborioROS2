...
RUN echo "Run from here"
RUN apt-get update
RUN apt-get install -y python3-colcon-common-extensions python3-rosdep2 python3-rosinstall-generator python3-wstool python3-rosinstall build-essential
